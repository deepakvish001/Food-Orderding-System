# convert django model to json is called serialization
# convert json to django model is called deserialization
...
class FoodSerializer(serializers.ModelSerializer):
 category_name = serializers.CharField(source='category.category_name', read_only=True)    #for accessing value of forenkey
 ...
 class Meta:
  model = Food 
  fields = ['id', 'category' ,'category_name', 'item_name', 'price', 'item_description', 'image', 'item_quantity', 'is_available']
...
class WishlistSerializer(serializers.ModelSerializer):
    ...
    item_description = serializers.CharField(source='food.item_description', read_only=True)
    image = serializers.ImageField(source='food.image', read_only=True)
    is_available = serializers.CharField(source='food.is_available')
    class Meta:
        model = Wishlist
        fields = ['food_id', 'item_name', 'price', 'item_description', 'image', 'is_available']
